...
final class Surfboard extends Base
{
    public function getContent($user): string
    {
        $nodes = [];
        $surfboard_config = $_ENV['Surfboard_Config'];
        $nodes_raw = Subscribe::getUserNodes($user);

        foreach ($nodes_raw as $node_raw) {
            $node_custom_config = json_decode($node_raw->custom_config, true);

            // 仅支持最小子集，v2ray+ws+tls
            switch ((int) $node_raw->sort) {
                case 11:
                    ...
                    $nodestr = "vmess, {$node_raw->server}, {$v2_port}, username={$user->uuid}, tls=true, vmess-aead=true, ws=true, ws-path={$path}, sni={$host}, ws-headers=Host:{$host}, skip-cert-verify=false, tfo=false, udp-relay=true";
                    
                    $nodes[$node_raw->name] = $nodestr;
                    break;
                default:
                    break;
            }
        ...
        $NAMES = implode('', array_map(function($nodestr) { return ','.$nodestr; }, array_keys($nodes)));
        $SERVERS = implode("\n", array_map(function($name, $nodestr) { return $name.' = '.$nodestr; }, array_keys($nodes), array_values($nodes)));
        return str_replace(array('{NAMES}', '{SERVERS}'), array($NAMES, $SERVERS), $surfboard_config);
    }
}


$_ENV['Surfboard_Config'] = <<<EOF
[General]
loglevel = notify
interface = 127.0.0.1
...
[Proxy Group]
Proxies = select,Auto - UrlTest,DIRECT{NAMES}
Domestic = select,DIRECT,Proxies
Scholar = select,DIRECT,Proxies{NAMES}
Others = select,Proxies,DIRECT
AdBlock = select,REJECT,DIRECT,Proxies
Apple = select,DIRECT,Proxies
AsianTV = select,DIRECT,Proxies
GlobalTV = select,Proxies,DIRECT{NAMES}
Netflix = select,Proxies,DIRECT{NAMES}
Spotify = select,Proxies,DIRECT{NAMES}
Telegram = select,Proxies,DIRECT{NAMES}
Steam = select,Proxies,DIRECT
Speedtest = select,Proxies,DIRECT,Domestic{NAMES}
PayPal = select,DIRECT,Proxies
Microsoft = select,Proxies,DIRECT
Netease Music = select,DIRECT,Proxies
Auto - UrlTest = url-test{NAMES},url=http://cp.cloudflare.com/generate_204,interval=1800
...
IP-CIDR,23.246.18.0/23,Netflix,no-resolve
...
DOMAIN-SUFFIX,disney.asia,GlobalTV
DOMAIN-SUFFIX,disney.be,GlobalTV
DOMAIN-SUFFIX,disney.bg,GlobalTV
DOMAIN-SUFFIX,disney.ca,GlobalTV
DOMAIN-SUFFIX,disney.ch,GlobalTV
DOMAIN-SUFFIX,disney.co.il,GlobalTV
DOMAIN-SUFFIX,disney.co.jp,GlobalTV
DOMAIN-SUFFIX,disney.co.kr,GlobalTV
DOMAIN-SUFFIX,disney.co.th,GlobalTV
DOMAIN-SUFFIX,disney.co.uk,GlobalTV
DOMAIN-SUFFIX,disney.co.za,GlobalTV
DOMAIN-SUFFIX,disney.com,GlobalTV
DOMAIN-SUFFIX,disney.com.au,GlobalTV
DOMAIN-SUFFIX,disney.com.br,GlobalTV
DOMAIN-SUFFIX,disney.com.hk,GlobalTV
DOMAIN-SUFFIX,disney.com.tw,GlobalTV
DOMAIN-SUFFIX,disney.cz,GlobalTV
DOMAIN-SUFFIX,disney.de,GlobalTV
DOMAIN-SUFFIX,disney.dk,GlobalTV
DOMAIN-SUFFIX,disney.es,GlobalTV
DOMAIN-SUFFIX,disney.fi,GlobalTV
DOMAIN-SUFFIX,disney.fr,GlobalTV
DOMAIN-SUFFIX,disney.gr,GlobalTV
DOMAIN-SUFFIX,disney.hu,GlobalTV
DOMAIN-SUFFIX,disney.id,GlobalTV
DOMAIN-SUFFIX,disney.in,GlobalTV
DOMAIN-SUFFIX,disney.io,GlobalTV
DOMAIN-SUFFIX,disney.it,GlobalTV
DOMAIN-SUFFIX,disney.my,GlobalTV
DOMAIN-SUFFIX,disney.nl,GlobalTV
DOMAIN-SUFFIX,disney.no,GlobalTV
DOMAIN-SUFFIX,disney.ph,GlobalTV
DOMAIN-SUFFIX,disney.pl,GlobalTV
DOMAIN-SUFFIX,disney.pt,GlobalTV
DOMAIN-SUFFIX,disney.ro,GlobalTV
DOMAIN-SUFFIX,disney.ru,GlobalTV
DOMAIN-SUFFIX,disney.se,GlobalTV
DOMAIN-SUFFIX,disney.sg,GlobalTV
DOMAIN-SUFFIX,20thcenturystudios.com.au,GlobalTV
DOMAIN-SUFFIX,20thcenturystudios.com.br,GlobalTV
DOMAIN-SUFFIX,20thcenturystudios.jp,GlobalTV
DOMAIN-SUFFIX,adventuresbydisney.com,GlobalTV
DOMAIN-SUFFIX,babble.com,GlobalTV
DOMAIN-SUFFIX,babyzone.com,GlobalTV
DOMAIN-SUFFIX,bamgrid.com,GlobalTV
DOMAIN-SUFFIX,beautyandthebeastmusical.co.uk,GlobalTV
DOMAIN-SUFFIX,dilcdn.com,GlobalTV
DOMAIN-SUFFIX,disney-asia.com,GlobalTV
DOMAIN-SUFFIX,disney-discount.com,GlobalTV
DOMAIN-SUFFIX,disney-plus.net,GlobalTV
DOMAIN-SUFFIX,disney-portal.my.onetrust.com,GlobalTV
DOMAIN-SUFFIX,disney-studio.com,GlobalTV
DOMAIN-SUFFIX,disney-studio.net,GlobalTV
DOMAIN-SUFFIX,disney.my.sentry.io,GlobalTV
DOMAIN-SUFFIX,disneyadsales.com,GlobalTV
DOMAIN-SUFFIX,disneyarena.com,GlobalTV
DOMAIN-SUFFIX,disneyaulani.com,GlobalTV
DOMAIN-SUFFIX,disneybaby.com,GlobalTV
DOMAIN-SUFFIX,disneycareers.com,GlobalTV
DOMAIN-SUFFIX,disneychannelonstage.com,GlobalTV
DOMAIN-SUFFIX,disneychannelroadtrip.com,GlobalTV
DOMAIN-SUFFIX,disneycruisebrasil.com,GlobalTV
DOMAIN-SUFFIX,disneyenconcert.com,GlobalTV
DOMAIN-SUFFIX,disneyiejobs.com,GlobalTV
DOMAIN-SUFFIX,disneyinflight.com,GlobalTV
DOMAIN-SUFFIX,disneyinternational.com,GlobalTV
DOMAIN-SUFFIX,disneyinternationalhd.com,GlobalTV
DOMAIN-SUFFIX,disneyjunior.com,GlobalTV
DOMAIN-SUFFIX,disneyjuniortreataday.com,GlobalTV
DOMAIN-SUFFIX,disneylatino.com,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.co.il,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.co.uk,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.co.za,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.de,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.es,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.fr,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.gen.tr,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.gr,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.it,GlobalTV
DOMAIN-SUFFIX,disneymagicmoments.pl,GlobalTV
DOMAIN-SUFFIX,disneymagicmomentsme.com,GlobalTV
DOMAIN-SUFFIX,disneyme.com,GlobalTV
DOMAIN-SUFFIX,disneymeetingsandevents.com,GlobalTV
DOMAIN-SUFFIX,disneymovieinsiders.com,GlobalTV
DOMAIN-SUFFIX,disneymusicpromotion.com,GlobalTV
DOMAIN-SUFFIX,disneynewseries.com,GlobalTV
DOMAIN-SUFFIX,disneynow.com,GlobalTV
DOMAIN-SUFFIX,disneypeoplesurveys.com,GlobalTV
...
DOMAIN-SUFFIX,disneyredirects.com,GlobalTV
DOMAIN-SUFFIX,disneysrivieraresort.com,GlobalTV
DOMAIN-SUFFIX,disneystore.com,GlobalTV
DOMAIN-SUFFIX,disneystreaming.com,GlobalTV
DOMAIN-SUFFIX,disneysubscription.com,GlobalTV
DOMAIN-SUFFIX,disneytickets.co.uk,GlobalTV
DOMAIN-SUFFIX,disneyturkiye.com.tr,GlobalTV
DOMAIN-SUFFIX,disneytvajobs.com,GlobalTV
DOMAIN-SUFFIX,disneyworld-go.com,GlobalTV
DOMAIN-SUFFIX,dssott.com,GlobalTV
DOMAIN-SUFFIX,go-disneyworldgo.com,GlobalTV
DOMAIN-SUFFIX,go.com,GlobalTV
DOMAIN-SUFFIX,mickey.tv,GlobalTV
DOMAIN-SUFFIX,moviesanywhere.com,GlobalTV
DOMAIN-SUFFIX,nomadlandmovie.ch,GlobalTV
DOMAIN-SUFFIX,playmation.com,GlobalTV
DOMAIN-SUFFIX,shopdisney.com,GlobalTV
DOMAIN-SUFFIX,shops-disney.com,GlobalTV
DOMAIN-SUFFIX,sorcerersarena.com,GlobalTV
DOMAIN-SUFFIX,spaindisney.com,GlobalTV
DOMAIN-SUFFIX,star-brasil.com,GlobalTV
DOMAIN-SUFFIX,star-latam.com,GlobalTV
DOMAIN-SUFFIX,starwars.com,GlobalTV
DOMAIN-SUFFIX,starwarsgalacticstarcruiser.com,GlobalTV
DOMAIN-SUFFIX,starwarskids.com,GlobalTV
DOMAIN-SUFFIX,streamingdisney.net,GlobalTV
DOMAIN-SUFFIX,thestationbymaker.com,GlobalTV
DOMAIN-SUFFIX,thisispolaris.com,GlobalTV
DOMAIN-SUFFIX,watchdisneyfe.com,GlobalTV
...
IP-CIDR,23.246.18.0/23,GlobalTV,no-resolve
